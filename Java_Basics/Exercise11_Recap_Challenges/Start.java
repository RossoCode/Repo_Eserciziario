package Java_Basics.Exercise11_Recap_Challenges;
...
public class Start {
     ...
     *
     *    Java_Basics.Exercise11_Recap_Challenges.Java_Basics.Exercise12_Arrays_Lists.Java_Basics.Exercise13_For_loops_for_each_for_i.Java_Basics.Exercise14_While_loop_do_while_loop.Exercise15Functions_Methods.Java_Basics.Exercise16_Other_useful_types_in_Java_Date_advanced_primitives.Start with a base score of the string's length, this is the starting score. Use .length() on a string
     *
    ...
    public static double exercise1(String text, double expectedScore) {
        double yourScore = 0;
        // Java_Basics.Exercise11_Recap_Challenges.Java_Basics.Exercise12_Arrays_Lists.Java_Basics.Exercise13_For_loops_for_each_for_i.Java_Basics.Exercise14_While_loop_do_while_loop.Exercise15Functions_Methods.Java_Basics.Exercise16_Other_useful_types_in_Java_Date_advanced_primitives.Start your code here
