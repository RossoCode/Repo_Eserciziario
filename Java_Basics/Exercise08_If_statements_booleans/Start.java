package Java_Basics.Exercise08_If_statements_booleans;
...
public class Start {
    ...
    private static void exercise4() {
        ...
        } else if (employeeAge >= 18 && employeeAge< 65)
        {
        ...
        //in questo caso per ultimo lascio un else perché la condizione di minore 18  e gia garantita dal precedente else if
        // ma se volessi essere preciso per non avere errori mi basterebbe mettere else if(employeeAge <18)
