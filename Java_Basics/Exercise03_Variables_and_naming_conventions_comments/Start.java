package Java_Basics.Exercise03_Variables_and_naming_conventions_comments;
...
public class Start {
    ...
    private static void exercise2() {
        ...
        int age = 22;
        char lecter = 'L';
        System.out.println("Eta' =" + age + " La mia iniziale = " + lecter);
        //Write your code here
    }
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        //serve per comprendere se si ha pranzato
        boolean hasEatenLunch = false;
        // il costo del pranzo
        double lunchCost = 5.99;
        // stampi il risultato per capire quanto costa il pranzo
        System.out.println("Lunch cost=" + lunchCost);
        // stampi il risultato per capire se ha pranzato
