package Java_Basics.Exercise06_String;
...
public class Start {
    ...
    private static void exercise1() {
        ...
        String CharacterName= "Ralzik Ikar";
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Rosso";
        String middleName = "Alexander";
        String lastName = "Zanna";
    ...
    private static void exercise3() {
        ...
        double Dn= 1.5;
                int In= 67;
                        char Cn= 'b';
                                boolean Bn= true;
        String textFrom2Primitives = Cn + "" + In; // <--- Edit this line
        System.out.println(textFrom2Primitives);
        textFrom2Primitives = Dn + "" + In;
        System.out.println(textFrom2Primitives);
        textFrom2Primitives = Cn + " " + Bn;
        System.out.println(textFrom2Primitives);
        textFrom2Primitives = In + " " + Bn;
        System.out.println(textFrom2Primitives);
    }
