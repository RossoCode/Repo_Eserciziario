package Exercise11_Recap_Challenges;
...
public class Start {
     ...
     *
     *    Exercise11_Recap_Challenges.Exercise12_Arrays_Lists.Exercise13_For_loops_for_each_for_i.Exercise14_While_loop_do_while_loop.Exercise15Functions_Methods.Exercise16_Other_useful_types_in_Java_Date_advanced_primitives.Start with a base score of the string's length, this is the starting score. Use .length() on a string
     *
    ...
    public static double exercise1(String text, double expectedScore) {
        double yourScore = 0;
        // Exercise11_Recap_Challenges.Exercise12_Arrays_Lists.Exercise13_For_loops_for_each_for_i.Exercise14_While_loop_do_while_loop.Exercise15Functions_Methods.Exercise16_Other_useful_types_in_Java_Date_advanced_primitives.Start your code here
